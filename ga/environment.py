...
class Environment:
    ...
    def saveFitness(self, population: list, iD):
        ...
        with open(path.abspath(f'files/grafico_{iD}.npy'),"ab+") as file:
    ...
    def showGraph(self, ):
        ...
        for i in range(self.amount):
            ...
            bests = np.ndarray((0))
            worst = np.ndarray((0))
            with open(path.abspath(f'files/grafico_{i}.npy'),"rb") as file:
            ...
            labels = ["Caso Médio", "Melhor Caso", "Pior Caso"]
    ...
    def resetData(self, ):
        for iD in range(self.amount):
            open(path.abspath(f'files/grafico_{iD}.npy'),"wb").close()
